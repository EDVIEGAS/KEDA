...
<section class="content text-sm">
        ...
        <div class="card">
          ...
          <div class="box-tools col-1 mt-2 ml-3 mb-0">
              ...
              <div class="row" data-idcampeonato="<?php echo $idcampeonato;?>" id="id_campeonato567">
                <div class="col-12 col-md-12 col-lg-12 order-2 order-md-1">
                  <div class="row">
                    <div class="col-12 text-center">
                      <legend class="f-w-700 p-b-5 m-t-0 mb-40 text-inverse text-center text-bold text-uppercase">CAMPEONATO PROVINCIAL DO <?php echo $this->session->userdata('nome'); ?></legend><br>
                        ...
                        <?php if ($valorControl == 1) {?>
                          <div class="row pt-5">
                                        ...
                                        <div class="card card-info">
                                          ...
                                          <div class="card-body">
                                              ...
                                              <div class="tab-content" id="custom-content-below-tabContent">
                                                ...
                                                <div class="card-body">
                                                    <div class="col-sm-12">
                                                      <div class="text-danger" id="feedbackERRO3452SL00">
                                              ...
                                              <div class="invoice p-3 mb-3" style="background:#f4f6f9">
                                                ...
                                                <div class="row invoice-info rounded-top mb-3">
                                                  ...
                                                  <div class="col-sm-12 invoice-col pb-0 text-sm">
                                                      <h6 class="text-bold">INFORMAÇÕES DO CAMPEONATO</h6><br>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                  <div class="col-12">
                                                    <div class="table-responsive" id="mostrarInfoCampeonato45adas">
                                                    ...
                                                    <div class="table-responsive mostrarInfoCampeonato45" style="height:400px" id="mostrarInfoCampeonato45457">
                                                        <div class="card card-info">
                                                                  <div class="card-header p-2" style="border-top-left-radius:0;border-top-right-radius:0">
                                                                    <h6 class="card-title text-uppercase text-sm" style="margin-left: 0px">SISTEMA DE LUTA</h6>
                                                                  </div>
                                                                ...
                                                                <?php foreach($teste as $teste){?>
                                                                  <div class="card-header p-2" style="border-top-left-radius:0;border-top-right-radius:0">
                                                                    <h6 class="card-title text-uppercase text-sm" style="margin-left: 0px">ESCALAO ETARIO - <?php echo $teste['descricao_escalao']?></h6>
                                                                  </div>
                                                ...
                                                <div class="row no-print pt-2" hidden id="esconderBotao98131213327">
                                                  <div class="col-12">
                                                    ...
                                                    <button type="button" class="btn btn-success float-right" id="salvarInformacoesCampeonatoPorvincial765"> Salvar Definicoes
                                                    </button>
                              ...
                              <div class="col-7" style="top:7px">
                                <div class="card border" style="margin-right: 22px;">
                                    ...
                                    <div class="col-sm-2" data-idcampeonato="<?php echo $idcampeonato;?>" id="id_campeonato567">
                                        <div class="btn-group col-sm-10 float-right btn-sm" style="left:73px">
                                          ...
                                          <div class="dropdown-menu" role="menu" style="">
                                            ...
                                            <a class="dropdown-item idCompetidorProvincial" href="#"><i class="fas fa-user-plus fa-fw"></i> Competidor </a>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="btn-group col-sm-10 float-right btn-sm" style="left:29px">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-sm" role="menu" style="">
                                            ...
                                            <a class="dropdown-item idLista5429tyutyu" href="#"><i class="fas fa-list fa-fw"></i> Ver Lista </a>
                                  ...
                                  <div class="col-sm-12 input-group input-group-sm">
                                    <legend class="text-center text-bold text-uppercase text-sm p-3"> LISTA DOS PARTICIPANTES NO PROVINCIAL </legend><br>
                                  </div>
                                  <!-- /.card-header -->
                            ...
                            <div class="mt-5 mb-4 ml-4">
                              <button class="btn btn-success me-md-2 btn-sm" id="me-md-graduacaoListaValidar12" type="button"><i class="fa fa-save" ></i> Validar Lista </button>
                            </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                      ...
                                      <div class="invoice p-3 mb-3">
                                        ...
                                        <div class="row invoice-info">
                                                          ...
                                                          <div class="card-body border-0 pt-0 pl-0 pr-0">
                                                            ...
                                                            <div class="justify-content-between align-items-center border-bottom mb-3">
                                                              ...
                                                              <?php foreach($participante['generos'] as $genero){ ?>
                                                                <?php if($genero['categoriaPesos'] != null){ ?>
                                                ...
                                                <div class="card-header border" style="background:#f4f6f9;">
                                                  ...
                                                  <?php foreach($layoutClassificacaoFinal as $ClassificacaoFinal){ ?>
                                                      ...
                                                      <!-- <div class="card"> -->
                                                        ...
                                                        <?php if($ClassificacaoFinal['escalao'] != null){ ?>
                                                    ...
                                                    <div class="invoice p-3 mb-3">
                                                      ...
                                                      <div class="row no-print">
                                                        <div class="col-12 mt-2 ml-3 mb-0">
                                                          ...
                                                          <button type="button" class="btn btn-info float-right gerarRelatorioFinalCampeonatoProvincial btn-sm" style="margin-right: 5px;" id="gerarRelatorioFinalCampeonato">
                                          ...
                                          <div class="row no-print">
                                            <div class="col-12">
                                              <a href="#" type="button" data_id_campeonato="<?php echo $idcampeonato ?>" controlBotaoFinalizar="<?php echo $participanteEPcamp[0] ?>" class="btn btn-info btn-sm float-left floatright78956tre34667as234" id="floatright78956tre34667as234" style="margin-right: 5px;">
                                                Finalizar
                                              </a>
                                            </div>
                                          </div>
                                ...
                                <div class="col-12 col-sm-12">
                                  <div class="info-box bg-info">
                                    <div class="info-box-content">
                                      <span class="info-box-text text-center">Total de Participantes</span>
                                      <span class="info-box-number text-center mb-0 info-box-number555"><?php echo $totalParticipante; ?></span>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-12 col-sm-12">
                                  <div class="info-box bg-info">
                                    <div class="info-box-content">
                                      <span class="info-box-text text-center">Masculino</span>
                                      <span class="info-box-number text-center mb-0 info-box-number222"><?php echo $totalParticipanteMasc; ?></span>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-12 col-sm-12">
                                  <div class="info-box bg-info">
                                    <div class="info-box-content">
                                      <span class="info-box-text text-center">Femenino</span>
                                      <span class="info-box-number text-center mb-0 info-box-number666"><?php echo $totalParticipanteFem; ?></span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                    ...
                                    <div class="card-body border">
                                      <div class="row">
                                        <div class="col-12 col-md-12 col-lg-7 order-2 order-md-1">
                                            ...
                                            <div class="col-12 col-sm-4">
                                              <div class="info-box bg-light">
                                                <div class="info-box-content">
                                                  ...
                                                  <span class="info-box-number text-center text-muted mb-0 info-box-number555"><?php echo $totalParticipante; ?></span>
                                                </div>
                                              </div>
                                            </div>
                                            <div class="col-12 col-sm-4">
                                              <div class="info-box bg-light">
                                                <div class="info-box-content">
                                                  ...
                                                  <span class="info-box-number text-center text-muted mb-0 info-box-number222"><?php echo $totalParticipanteMasc; ?></span>
                                                </div>
                                              </div>
                                            </div>
                                            <div class="col-12 col-sm-4">
                                              <div class="info-box bg-light">
                                                <div class="info-box-content">
                                                  ...
                                                  <span class="info-box-number text-center text-muted mb-0 info-box-number666"><?php echo $totalParticipanteFem; ?></span>
                                                </div>
                                              </div>
                                            </div>
                                          </div> -->
                                          <div class="row">
                                            <div class="col-12">
                                              <h5 class="text-center bg bg-info p-2">LISTA DOS PARTICIPANTES</h5>
                                                <div class="border">
                                                  <div class="card-body table-responsive p-0 bg bg-light" style="height: 700px;">

                                                        <div class="col-lg-12">
                                                              <!-- <div class="justify-content-between align-items-center border-bottom"> -->
                                                                                                    ...
                                                                                                    <div class="table-responsive col-lg-12">
                                                                                                      <table class="table table-sm text-sm">
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                              ...
                                                                                                              <?php foreach($participanteEPcamp5 as $participante){ ?>

                                                                                                                <tr>
                                                                                                                  <td>
                                                                                                                    <div class="user-block">
                                                                                                                      <?php if($participante->imagem == null){?>
                                                                                                                        <img class="img-circle img-bordered-sm border-0 p-0" src="http://localhost/KEDA/assets/images/3.jpg" alt="User Image">
                                                                                                                      <?php }else{ ?>
                                                                                                                        <img class="img-circle img-bordered-sm border-0 p-0" src="<?= base_url('uploads/product/' . $participante->imagem);?>" alt="User Image">
                                                                                                                      <?php } ?>
                                                                                                                  ...
                                                                                                                  <td>
                                                                                                                      ...
                                                                                                                      <span class="username">
                                                                                                                          ...
                                                                                                                          <?php echo $participante->nome_participante; ?>
                                                                                                                  ...
                                                                                                                  <td>
                                                                                                                      ...
                                                                                                                      <span class="username">
                                                                                                                        <?php echo $participante->categoria . "kg"; ?>
                                                                                                                      </span>
                                                                                                                  ...
                                                                                                                  <td>
                                                                                                                      ...
                                                                                                                      <span class="username">
                                                                                                                        <?php echo $participante->categoriaPeso . "kg"; ?>
                                                                                                                      </span>
                                        ...
                                        <div class="col-12 col-md-12 col-lg-5 order-1 order-md-2 border" data_id_campeonato="<?php echo $idcampeonato ?>" id="pegarListaCategoria7645390654321">
                                          <h5 class="text-primary pt-2 text-center text-bold"> CLASSIFICACAO FINAL</h5>
                                          <div class="card-body table-responsive p-0" style="height: 400px;">
                                          ...
                                          <h5 class="mt-5 text-muted">Ficheiros</h5>
                                          <ul class="list-unstyled">

                                            <li>
                                              <a href="http://localhost/KEDA/Campeonato/GerarPDFListarParticipantesCampeonatoProvincial/<?php echo $idcampeonato ?>" class="btn-link text-secondary"><i class="far fa-fw fa-file-pdf fa-2x text-danger"></i> Lista dos Participantes.pdf</a>
                                            </li>
                                            <li>
                                              <a href="" class="btn-link text-secondary gerarRelatorioFinalCampeonatoProvincial"><i class="far fa-fw fa-file-pdf fa-2x text-danger"></i> Relatorio.pdf</a>
                                            </li>
                                            <li>
                                              <a href="" class="btn-link text-secondary"><i class="far fa-fw fa-file-pdf fa-2x"></i> UAT.pdf</a>
                                            </li>
