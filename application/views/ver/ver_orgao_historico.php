...
<section class="content">
      ...
      <div class="card">
        <div class="card-header" style="border-bottom: 0px solid">
            ...
            <a href="http://localhost/KEDA/Orgao_Social/GerarPDF/<?php echo $mandato_atual?>" id_mandato_atual = <?= $mandato_atual ?> type="button" class="btn btn-primary btn-sm mb-4" style="margin-left:79px" id="criarPDF123">
              <i class="fa fa-file-alt t-plus-1 text-white fa-fw fa-lg"></i> Criar PDF
            </a>
        ...
        <div class="row">
          <div class="col-12" id="bodyMensagem89TESTE123">
            <div class="card" style="right: 0px;margin-right: 100px;margin-left: 100px;box-shadow: none">
            <?php foreach($orgaos as $orgao){?>
              <div class="card-header" style="background-color: #17a2b8; color: #fff;border-top-left-radius:0px;border-top-right-radius:0px">
