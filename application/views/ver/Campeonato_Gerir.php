                ...
                <div class="col-12">
                  <div class="card">
                            ...
                            <div class="card-header" id="MCP456">
                              <form method="post" id="registrarMundialAfricano345" action="<?php echo base_url('registrarMundialAfricano'); ?>">
                                ...
                                <div class="col-md-12" id="conteudoCarregar5955">
                                              ...
                                              <div class="form-row">
                                                  ...
                                                  <div class="form-group col-sm-6">
                                                      ...
                                                      <!-- <select name="ano" class="form-control form-control-sm" id="controlTipoExame756">
                            ...
                            <div class="row col-12 ml-0 mr-0 p-3" id="MCP456123" hidden>
                              ...
                              <div class="col-sm-4 input-group input-group-sm">
                                ...
                                <input type="text" id="table_search876678" name="table_search" class="form-control form-control-navbar border" placeholder="Adicionar Bilhete de Identidade" style="border:0px solid;" onkeyup="pegarViaBilheteParticipanteMundial()">
                              </div>
                            </div>
