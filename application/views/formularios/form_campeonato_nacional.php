                        ...
                        <div class="box-tools">
                            ...
                            <div class="row">
                                ...
                                <br><div class="col-md-1">
                                    <a class="btn btn-primary btn-block btn-sm" href="<?= site_url('listaNacional');?>" style="border-top-width: 0px;margin-top: 26px;margin-bottom: 18px;"><i class="fa fa-list"></i> Listar </a>
                                </div>
                                <br>
                                <!-- begin col-8 -->
                                <div class="col-md-12">
                                    <legend class="f-w-700 p-b-5 m-t-0 mb-40 text-inverse text-center">CADASTRAR CAMPEONATO NACIONAL</legend>

                                    <form method="post" id="addCampeonatoNacional874">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <select id="tipoCampeonato" class="form-control form-control-sm" name="campeonatoNome">
                                                                <option value="Provincial">Nacional</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <input type="number" min="1" name="Edicao" placeholder="Escrever aqui" data-parsley-group="step-1" data-parsley-required="true" class="form-control form-control-sm" id="provincia_bilhete" value="">
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <!-- <div class="form-group col-sm-6">
                                                        ...
                                                        <div class="form-group col-sm-6">
                                                          <label>Data e Hora de Inicio</label>
                                                            <div class="input-group date" id="reservationdatetime1" data-target-input="nearest">
                                                                <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#reservationdatetime1" name="data_inicio">
                                                        ...
                                                        <div class="form-group col-sm-6">
                                                          <label>Data e hora do Fim</label>
                                                            <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                                                <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#reservationdatetime" name="data_fim">
