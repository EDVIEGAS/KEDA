        ...
        <div class="row">
            ...
            <div class="box-tools">
                ...
                <br><div class="col-md-1">
                    <a class="btn btn-primary btn-block btn-sm" href="<?= base_url('listaMestre');?>"><i class="fa fa-list"></i> Listar </a>
                </div>
                <br>

                <div class="form-row">
                <div class="col-md-12">
                    <legend class="f-w-700 p-b-0 m-t-0 m-b-20 f-s-14 text-center"> CASDASTRAR MESTRE </legend>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <select id="Graduacao" class="form-control form-control-sm" name="Graduacao">
                                    ...
                                    <?php for($i=0;$i < 13;$i++){ ?>
                                        <?php if($i != 0){?>
                                            <option value="<?= $i ?>"><?= $i ?>º DAN</option>
                                        <?php }else{?>
                                            <option value="<?= $i ?>">Preto</option>
                                        <?php }?>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                          <div class="form-group col-sm-3">
                              <label class="col-form-label text-md-right">Associacao Provincial<span class="text-danger"></span></label>
                              <select class="form-control form-control-sm" name="id_associacao_pro" id="estilo">
                                  <?php echo $associacao_provincial; ?>
                              </select>
                          </div>
                          <div class="form-group col-sm-3">
