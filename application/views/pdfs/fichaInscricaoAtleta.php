    ...
    <!-- <div> -->
      ...
      <!-- <div style="width:100%;padding-bottom:1px;font-size:10px;text-align: center"> -->
        ...
        <div style="text-align:center;font-size:16px;">
          <strong><label style="border-bottom: 1px solid black">FICHA DE CADASTRO DE ATLETA - FAJUJ</label></strong>
        </div>
    	<!-- </div> -->
      ...
      <br>
  		...
  		<table style="font-size:12px;line-height:4px">
                                  <thead style="background-color:#17a2b8;color:white;">
                                      <tr>
                                          <td colspan="4" style="text-align:left">INFORMACAO ENDERECO</td>
                                      </tr>
                                  </thead>
                                  <tbody>
                                      <tr class="">
  		...
  		<table style="font-size:12px;line-height:4px">
                                  <thead style="background-color:#17a2b8;color:white;">
                                      <tr>
                                          <td colspan="4" style="text-align:left">INFORMACAO CONTACTO</td>
                                      </tr>
                                  </thead>
                                  <tbody>
  		...
  		<table style="font-size:12px;line-height:4px">
                                  <thead style="background-color:#17a2b8;color:white;">
                                      <tr>
                                          <td colspan="4" style="text-align:left">INFORMACOES TECNICAS</td>
                                      </tr>
                                  </thead>
                                  <tbody>
                                      <tr class="">
                                      	 <td width="20%" style="background-color:#eeeeee;color:#2d2d2d;text-align: right">Graduacao</td>
                                      	 <td colspan="3" style="text-align: left;color:#2d2d2d"> </td>
                                      </tr>
                                      <tr class="">
                                      	 <td width="20%" style="background-color:#eeeeee;color:#2d2d2d;text-align: right">Estilo</td>
                                      	 <td style="text-align: left;color:#2d2d2d"></td>
                                         <td width="10%" style="text-align: right;color:#2d2d2d;background-color:#eeeeee;">Peso</td>
                                         <td style="text-align: left;color:#2d2d2d"></td>
                                      </tr>
                                      <tr class="">
                                      	 <td width="20%" style="background-color:#eeeeee;color:#2d2d2d;text-align: right">Academia</td>
                                      	 <td colspan="3" style="text-align: left;color:#2d2d2d"></td>
                                      </tr>
                                      <tr class="">
                                      	 <td width="20%" style="background-color:#eeeeee;color:#2d2d2d;text-align: right">Hablitacoes Literarias</td>
                                      	 <td colspan="3" style="text-align: left;color:#2d2d2d"></td>
                                      </tr>
