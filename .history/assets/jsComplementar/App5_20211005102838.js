                    ...
                    if (event2 == 7) {
                        ...
                        $('#modal-default-Pesquisa-vazia').modal({ show: true });
                            ...
                            $('#AddParticipanteEvente874').on('submit', function(event) {
                                ...
                                let modalParticipanteExiste = `<div class="modal fade text-sm pb-5 hide" id="modal-Editar-modalParticipanteExiste-4567">
                                ...
                                if (!$('modal-Editar-modalParticipanteExiste-4567').length) {
                                    $('body').append(modalParticipanteExiste);
                                }
                        ...
                        alert(event);
                                            if(event == 89876){
                                                $('#modal-Editar-modalParticipanteExiste-4567').modal({ show: true });
                                            }else{
