                            ...
                            $('#AddParticipanteEvente874').on('submit', function(event) {
                                ...
                                $.post('http://localhost/KEDA/Campeonato/getIdCampeonatoCorrente', dado90, function(event3) {
                                    ...
                                    $.ajax({
                                        ...
                                        beforeSend: function() {
                                            $('#bodyMensagem89').addClass("text-center").html('<div class="spinner-grow text-primary text-center" role="status"></div>');
                                        },
                                        success: function(event) {
                                          
                                            if(event == 89876){
                                                $('#bodyMensagem89').addClass("text-center").html('<div class="text-center text-bold" style="color: red;margin-left: 200px;font-size:22px">Esse Participante ja foi adicionado</div>');
                                            }else{
