                                ...
                                $.post('http://localhost/KEDA/Campeonato/getIdCampeonatoCorrente', dado90, function(event3) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(event) {
                                            ...
                                            if(event == 89876){
                                                $('#bodyMensagem89').addClass("text-center").html('<div class="text-center text-bold" style="color: red;margin-left: 200px;font-size:18px">Esse Participante ja foi adicionado</div>');
                                            }else{
