...
// function verificarEventoTipo(){
//     const nomeActi = $('#pegarListaCategoria76453').attr('nomeEventoActividade');
//
//     return
// }
...
function pegarViaBilheteParticipanteEvento() {
        ...
        <form method="post" id="AddParticipanteEvente87490">
            <div id="bodyMensagem89" class="modal-body m-2 pt-2 pb-3 row">
                ...
                <div class="col-md-8" id="conteudoCarregar5955">
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-6">
                                <label class="text-nowrap">Peso</label>
    ...
    if (numeroBI.length === 14) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                $('#AddParticipanteEvente87490').html('<div class="text-center p-4"><div class="spinner-border" style="width: 2.5rem; height: 2.5rem;" role="status"><span class="sr-only"></span></div> PROCURANDO....</div>');
            },
            success: function(event) {
                    ...
                    if (event2 == 7) {
                        ...
                        $("#AddParticipanteEvente87490").html(mostra);
                            ...
                            let mostraConteudo345 = `
                                <div id="bodyMensagem89" class="modal-body m-2 pt-2 pb-3 row col-md-12">
                                    <div class="col-md-4">
                                        <img class="img-bordered-sm img-bordered-sm23IMAGEM6745" src="http://localhost/KEDA/assets/images/3.JPG" alt="user image" style="height:200px; width:170px;border-radius:24px;">
                                    </div>
                                    <div class="col-md-8" id="conteudoCarregar5955">
                                            <div class="form-row">
                                                <div class="form-group col-sm-12">
                                            ...
                                            <div class="form-row">
                                              ...
                                              <div class="form-group col-sm-4">
                                                  ...
                                                  <select name="escalao" id="escalaoCampeonato78P" class="form-control form-control-sm">

                                                  </select>
                                                  <div id="feedbackwedmwnhrj"></div>
                                              </div>
                            ...
                            $("#AddParticipanteEvente87490").html(mostraConteudo345);
                            ...
                            $.post('http://localhost/KEDA/Campeonato/getEscalaoCampeonato',{id_ddd},function(event){
                                    ...
                                    $('#escalaoCampeonato78P').html('<option value="75684"></option>');
                                    $('#escalaoCampeonato78P').append(event);
                            ...
                            $('#genero_categoria231').html(`<option value="${peso}">${peso} kg</option>`);
                            ...
                            $('#AddParticipanteEvente87490').unbind("submit").submit(function(event) {
                                ...
                                //
                                        ...
                                        if(escalao != "75684"){
                                          ...
                                          $.ajax({
                                              type: 'POST',
                                              data: {dados2:dados},
                                              url: 'http://localhost/KEDA/Campeonato/setParticipanteCompEventoProvincial',
                                              beforeSend: function() {
                                                  $('#bodyMensagem89').addClass("text-center").html('<div class="text-center p-4 text-bold col"><div class="spinner-border" style="width: 2.5rem; height: 2.5rem;" role="status"><span class="sr-only"></span></div> ADICIONANDO....</div>');
                                              },
                                              success: function(event) {
                                          ...
                                          $('#feedbackwedmwnhrj').html('<span class="text-danger">escolha uma opcao</span>');
                                        }
                            })
                    }
...
function carregarAllParticipante() {
    ...
    let id_campeonato = $('#id_campeonato567').attr('data-idcampeonato');
        ...
        $.post('http://localhost/KEDA/Campeonato/getParticipantes', {id_campeonato} , function(retorno) {
            ...
            let teste = JSON.parse(retorno);
                    ...
                    $.each(teste, function(i, retorno1) {
                        ...
                        let provincial = retorno1.id_associacao != 0 ? "*" : retorno1.provincia;
...
function carregarAllParticipanteLista(id_campeonato) {
    ...
    //     }
        ...
        $.post('http://localhost/KEDA/Campeonato/getParticipantes',{id_campeonato}, function(retorno) {
            ...
            if(teste.length !== 0){
              ...
              href45="http://localhost/KEDA/Campeonato/GerarPDFListarParticipantesCampeonato/"+id_campeonato;

              $('#urlPdf345Participante').attr("href", href45);
                ...
                tableCategoria += `<tbody>`;
                let soma = 0;
                let CompetidorTotal = 0;
                let TreinadorTotal = 0;
                let ArbitroTotal = 0;

                $.each(teste, function(i, retorno1) {
                    let peso = retorno1.categoriaPeso === null ? " " : retorno1.categoriaPeso + " kg";

                    if (retorno1.funcao == "Competidor") {
                      CompetidorTotal += 1;
                ...
                tableCategoria += `</tbody>`
                tableCategoria += `</table>`;
                tableCategoria += `<div class="pt-2">`;
                tableCategoria += `<span style="margin-left: 45px;">Total de Participantes : ${teste.length}</span><br>`;
                tableCategoria += `<span style="margin-left: 45px;">Competidor : ${CompetidorTotal}</span><br>`;
                tableCategoria += `<span style="margin-left: 45px;">Treinador  : ${TreinadorTotal}</span><br>`;
                tableCategoria += `<span style="margin-left: 45px;">Arbitro    : ${ArbitroTotal}</span>`;
                tableCategoria += `</div>`;
...
function carregarAllParticipanteCampNacional(id_campeonato) {
    ...
    //     }
        ...
        $.post('http://localhost/KEDA/Campeonato/getParticipantes',{id_campeonato}, function(retorno) {
            ...
            if(teste.length !== 0){
              ...
              href45="http://localhost/KEDA/Campeonato/GerarPDFListarParticipantesCampeonatoProvincial/"+id_campeonato;
